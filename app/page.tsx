  ...
  return (
    <main className='mx-auto max-w-7xl px-6 py-20'>
      <section className='rounded-3xl bg-gradient-to-br from-indigo-900 to-slate-900 p-12 text-white shadow-2xl'>
        ...
        <p className='mt-6 max-w-3xl text-lg text-indigo-100'>FaithSignal Builder V3 unifies sales, onboarding, billing, and LifeSignal Core automation for check-ins, escalations, incidents, and analytics.</p>
