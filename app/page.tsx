...
const features = [
  ...
  },
  {
    ...
    description:
      "Families, neighbors, recovery sponsors, and care teams can stay informed without constant manual follow-up.",
  },
  {
...
const audiences = [
  ...
  },
  {
    ...
    description:
      "Use structured accountability check-ins for recovery, wellness, or routine adherence.",
  },
  {
    title: "Communities",
    description:
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Families, caregivers, older adults living alone, recovery support networks, and communities that want a better daily safety system.",
  },
  {
