      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <section className="rounded-lg border border-gray-200 bg-white p-4">
          ...
          <ul className="space-y-2 text-sm text-gray-700">
            {((members ?? []) as Array<{ user_id: string; role: string; status: string }>).map((member) => (
        ...
        <section className="rounded-lg border border-gray-200 bg-white p-4">
          ...
          <ul className="space-y-2 text-sm text-gray-700">
            {((invites ?? []) as Array<{ email: string; expires_at: string; role: string; status: string }>).map((invite) => (
