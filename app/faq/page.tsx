...
export const metadata: Metadata = {
  title: "FAQ | LifeSignal",
  description:
    "Frequently asked questions about LifeSignal, including how it works, whether an app is required, what happens when a check-in is missed, and who it is for."
};

const faqs = [
  {
    question: "Does the person being checked in on need a smartphone?",
    answer:
  ...
  {
    question: "Is LifeSignal an emergency service?",
    answer:
  ...
  },
  {
    ...
    answer:
      "LifeSignal is a strong fit for families with loved ones living alone, caregivers managing routine wellness checks, recovery support settings, and connected communities that want a lightweight safety net."
  },
  {
    question: "Does LifeSignal track location or use cameras?",
    answer:
    ...
    <main className="min-h-screen bg-[#020817] text-white">
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 md:px-8 md:py-28">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-9 text-slate-300">
              These answers cover the most common questions families,
              caregivers, and communities have when exploring LifeSignal.
            </p>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="mx-auto max-w-5xl px-6 py-16 md:px-8 md:py-20">
          ...
          <div className="mt-12 rounded-3xl border border-white/10 bg-gradient-to-r from-sky-500/10 via-slate-900 to-indigo-500/10 p-8 md:p-12">
            ...
            <h2 className="mt-3 max-w-2xl text-3xl font-semibold tracking-tight text-white md:text-4xl">
              Reach out and we’ll walk you through how LifeSignal fits your situation.
            </h2>
