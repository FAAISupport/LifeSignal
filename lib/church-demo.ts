...
export const allChurchFeatures: ChurchFeature[] = [
  ...
  },
  {
    ...
    category: "health",
    tier: "care",
    description: "Scheduled reminders can ask members to confirm medications, post-op routines, or daily tasks.",
    valuePitch: "Useful for recovery ministry, elder care, and higher-risk member support."
  },
  {
  ...
  },
  {
    ...
    label: "Post-Hospital Recovery Protocol",
    short: "Structured recovery workflows",
    category: "health",
    tier: "advanced",
    ...
    valuePitch: "Turns the church into a more dependable recovery support system."
  },
  {
