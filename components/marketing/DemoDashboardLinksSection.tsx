...
const demoCards = [
  ...
  {
    title: "FaithSignal Dashboard",
    href: "/faithsignal",
    description:
      "A dedicated ministry operations experience for churches that want member care, outreach, follow-up, and add-on feature purchasing in one place."
  },
  {
